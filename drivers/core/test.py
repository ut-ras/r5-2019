...
scene1 = RobotState(DRIVE, 0, False, False)
scene2 = RobotState(DRIVE, 0, True, False)
scene3 = RobotState(DRIVE, 0, True, True)
...
time.sleep(2)
regV.RobotControl(scene3)
time.sleep(2)
regV.RobotControl(scene2)
time.sleep(2)
regV.RobotControl(scene1)
#regV.RobotControl(forward5)
#time.sleep(1)
