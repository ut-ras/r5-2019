...
def make_sym_trap(x0, xf, v, a):
    ...
    decreased. In this situation, the algorithm opts to choose the latter, as it creates no violations.
    ...
    return MotionProfile(MotionState(x0, 0, 0, 0, 0), MotionState(xf, 0, 0, 0, 0))\
